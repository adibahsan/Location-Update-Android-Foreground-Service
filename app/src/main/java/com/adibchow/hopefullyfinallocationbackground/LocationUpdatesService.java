...
package com.adibchow.hopefullyfinallocationbackground;
...
public class LocationUpdatesService extends Service {
    ...
    private static final String PACKAGE_NAME =
            "com.google.android.gms.location.deliveryapp.locationupdatesforegroundservice";
    ...
    private void onNewLocation(Location location) {
        ...
        if (serviceIsRunningInForeground(this)) {
            ...
            Log.d(TAG, "Updating New location When in Foreground Notification: " + location);
